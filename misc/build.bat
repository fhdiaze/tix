...
set "TixFilePath=.\src\%TixFileName%.c"
set "Outdir=.\bin"
set "Datadir=.\data"
set "OutPlatform=%Outdir%\%PlatformFileName%.exe"
set "OutTix=%Outdir%\%TixFileName%.dll"
...
set "TixFlags=!Flags!"
set "TixFlags=!TixFlags! -Wl,/MAP:%Outdir%/%TixFileName%.map"
set "TixFlags=!TixFlags! -Wl,/MAPINFO:EXPORTS"
set "TixFlags=!TixFlags! -Wl,/EXPORT:sound_create_samples"
set "TixFlags=!TixFlags! -Wl,/EXPORT:tix_update_and_render"
set "TixFlags=!TixFlags! -Wl,/PDB:%Outdir%/tix_%random%.pdb"
set "TixFlags=!TixFlags! -shared"

echo Building tix dll...
echo.
echo clang !TixFlags! %TixFilePath% -o %OutTix%
echo.
echo Waiting for pdb file>"%Outdir%\lock.tmp"
echo.

clang !TixFlags! %TixFilePath% -o %OutTix%
